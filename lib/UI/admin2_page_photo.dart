...
class Photo2 extends StatefulWidget {
  const Photo2({super.key, String? adminId});
...
class Photo2State extends State<Photo2> {
  File? galleryFile;
            ...
            Expanded(
              child: Padding(
                ...
                child: Column(
                  children: <Widget>[
                    CircleAvatar(
                      backgroundImage: AssetImage(r10),
                      radius: 150,
                    ),
                    Container(
                      height: 60.0,
            ...
            Expanded(
              child: Padding(
                ...
                child: Column(
                  children: [
                    CircleAvatar(
                      backgroundImage: AssetImage(r11),
                      radius: 150,
                    ),
                    Container(
                      height: 60.0,
            ...
            Expanded(
              child: Padding(
                ...
                child: Column(
                  children: <Widget>[
                    CircleAvatar(
                      backgroundImage: AssetImage(r12),
                      radius: 150,
                    ),
                    Container(
                      height: 60.0,
