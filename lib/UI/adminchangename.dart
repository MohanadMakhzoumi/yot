...
import 'package:restuarant/UI/adminchangeinfo.dart';
import 'package:restuarant/UI/adminsettingspage.dart';

import '../main.dart';

class AdminChangenamePage extends StatefulWidget {
  const AdminChangenamePage({super.key, required String? adminId});

  @override
  State<AdminChangenamePage> createState() => _AdminChangenamePageState();
}

final nameController = TextEditingController();

class _AdminChangenamePageState extends State<AdminChangenamePage> {
  var name;
  var phone_number;
  @override
